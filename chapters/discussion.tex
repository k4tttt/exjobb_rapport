...
% maybe have own section for real world perspective
\subsection{Limitations in a real-world application}
...
The choice of decision-tree ensemble models in this thesis alleviates the implementation of the forecast system into a real-world scenario. Decision-tree ensembles are known for their strength in handling uncertain data with outliers or missing values \cite{sagi_ensemble_2018,dong_survey_2020}. A robust decision-tree ensemble would be suitable... [FI and SHAP explanations showed that the models generally prioritized the previous month's consumption over the consumption for the same month last year, indicating that forecasting with these models may be possible even if the amount of historical consumption data is small.]
