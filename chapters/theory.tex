...
XAI methods can be applied at different stages of the AI modelling. Firstly, explainability can be applied pre-modelling explainability through means of data pre-processing and analysis. Secondly,
\cite{minh_explainable_2022}.
