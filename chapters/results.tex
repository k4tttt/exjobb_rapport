This chapter presents the results to \emph{experiment 1} and \emph{experiment 2} performed with the aim of answering the research questions. Firstly, the performance of the forecasting models is presented, as well as a comparison with the baseline model. Secondly, results of the explainable AI analysis is presented.
...
\begin{table}[h!tbp]%[H]
    \centering
    \caption{Performance of the ensemble forecasting models for \emph{experiment 1}, evaluated by internal versus total features.}
