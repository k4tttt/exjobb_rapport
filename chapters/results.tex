...
\begin{figure}[H]%[h!tbp]
    ...
    \caption{Feature importance (a) and SHAP summary (b) for RF.}
...
\begin{figure}[H]
    ...
    \caption{Feature importance (a) and SHAP summary (b) for GBM.}
...
\begin{figure}[H]
    ...
    \caption{Feature importance (a) and SHAP summary (b) for XGBoost.}
...
\begin{figure}[H]
    ...
    \caption{Feature importance (a) and SHAP summary (b) for LightGBM.}
...
\begin{figure}[H]
    ...
    \caption{Feature importance (a) and SHAP summary (b) for CatBoost.}
