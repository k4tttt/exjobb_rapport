This chapter presents the results to \emph{experiment 1} and \emph{experiment 2} with the aim of answering the research questions. Firstly, the performance of the forecasting models is presented, as well as a comparison with the baseline model. Secondly, results of the explainable AI analysis is presented.

\section{Experiment 1: Performance of Forecasting Models}
...
\begin{table}[h!tbp]%[H]
    \centering
    \caption{Performance of the ensemble forecasting models in \emph{experiment 1}, evaluated by internal versus total features.}
...
\begin{figure}[h!tbp]%[H]
    ...
    \caption{Graph representing the average actual versus predicted electricity consumption for all ensemble models in \emph{experiment 1}.}
...
\begin{figure}[h!tbp]%[H]
    ...
    \caption{Feature importance plot (a) and SHAP summary (b) for the GBM model in \emph{experiment 2}.}
...
\begin{figure}[h!tbp]%[H]
    ...
    \caption{Feature importance plot (a) and SHAP summary (b) for the XGBoost model in \emph{experiment 2}.}
...
\begin{figure}[h!tbp]%[H]
    ...
    \caption{Feature importance plot (a) and SHAP summary (b) for the LightGBM model in \emph{experiment 2}.}
...
\begin{figure}[h!tbp]%[H]
    ...
    \caption{Feature importance plot (a) and SHAP summary (b) for the CatBoost model in \emph{experiment 2}.}
