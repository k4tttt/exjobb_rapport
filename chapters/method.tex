...
\begin{itemize}
    ...
    \item Boxplot and histogram for general consumption, boxplots per month (like in 30 in \cite{moon_advancing_2024})
    \item It is also possible to make diagrams for the decomposition of the time series \cite{chakraborty_scenario-based_2021}.
    \item Could investigate correlation between external variables and consumption
