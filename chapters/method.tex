...
To evaluate the predictive performance of the forecasting models, three statistical metrics are used; mean average percentage error (MAPE), coefficient of variation of the root mean squared error (CVRMSE), and normalized mean average error (NMAE). These metrics express the performance in error percentage, making them intuitive to interpret. [Why these metrics?]
